...
import { Currency, useSettings } from "@/lib/context";
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <span className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-gray-400 font-medium">
                {getCurrencySymbol()}/{locale === "ru" ? "час" : "hr"}
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-1 p-0.5 bg-gray-100 rounded-lg h-10">
                ...
                >
                  {locale === "ru" ? "Без НДС" : "No VAT"}
                </button>
                <button
                  onClick={() => handleSettingChange({ taxMode: "vat" })}
                  className={`flex-1 rounded-md text-xs font-medium transition-all ${
                    settings.taxMode === "vat"
                      ? "bg-white text-gray-900 shadow-sm"
                      : "text-gray-600 hover:text-gray-900"
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-1 text-xs text-gray-500">
                ...
                <span>
                  {locale === "ru" ? "Буфер на риски" : "Risk margin"}
                </span>
              </div>
            </div>
